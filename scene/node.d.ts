...
declare namespace $ {
     ...
     */
    function $bog_vmap_scene_shown(spots: {
        readonly [name: string]: {
            readonly x: number;
            readonly y: number;
        };
    }, sizes: {
        readonly [name: string]: $bog_vmap_scene_box;
    }, view: $bog_vmap_scene_box, slack: number, names: readonly string[]): Set<string>;
    /**
     ...
     */
    function $bog_vmap_scene_viewport(camera: {
        readonly x: number;
        readonly y: number;
        readonly zoom: number;
    }, screen: {
...
declare namespace $.$$ {
    ...
    class $bog_vmap_scene extends $.$bog_vmap_scene {
        ...
        screen_listener(): $mol_dom_listener;
        /**
         ...
         */
        pack_fetch(uri: string): Promise<string>;
        /**
         ...
         */
        decorators(self: $mol_tree2, js: string): string;
        /**
         ...
         */
        js_defines(js: string, name: string): boolean;
        /**
